...
contract("Darray", () => { 
    ...
    it("Should get all the elements of arr", async () => { 
        ...
        // console.log(arr);  // It will return BN = Big Number Objects
        const elements = arr.map((element) => element.toNumber()); // Convert BN object array to number araay
        //console.log(elements); // O/P - Number Array
